...
function Content() {
  ...
  return (
    <div className="bg-image5 w-full xs:h-[330rem] sm:h-[420rem] lg:h-[415rem] flex flex-col items-center justify-center z-10">
  ...
  `,
    ...
    0 0 0 #F4C66B`,
      ...
      {/* daftar & poster */}
      <div className="xs:translate-y-[50rem] sm:translate-y-[45rem]">
