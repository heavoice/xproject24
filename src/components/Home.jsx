...
const Home = () => {
  return (
    <div className="bg-image w-full h-[300%] absolute md:justify-around -top-[15rem] sm:-top-[29rem] bg-cover bg-center bg-no-repeat">
      {/*welcome*/}
        ...
        <div className="w-fit mx-auto flex flex-col items-center">
          ...
          <div className="bg-[#F5F2CB] w-[70%] sm:w-[90%] md:w-[85%] lg:w-[80%] xl:w-[80%] mx-auto h-auto rounded-xl grid items-center p-6 sm:p-12 md:p-16 lg:p-24 relative -translate-y-16 sm:-translate-y-28 md:-translate-y-44 lg:-translate-y-80 xl:-translate-y-80">
            ...
            <div className="relative">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#9E7150] text-center sm:text-start mb-4">
                Apa sih <span className="text-red-800">x-project</span> itu?
              </h1>
              <p
                className="text-base sm:text-lg md:text-xl lg:text-2xl text-[#9E7150] text-justify mx-auto sm:mx-0 w-full sm:w-[80%] md:w-[70%] lg:w-[60%]"
