...
const TitleDaftar = ({ judul, isi }) => {
  return (
    <>
      <div>
        <div className="flex flex-col lg:flex-row  items-center justify-center lg:gap-20 px-4 py-6 bg-white border-4 border-black w-[90%] max-w-[1240px] h-auto lg:py-10 lg:w-[80%] rounded-xl bg-opacity-40 mx-auto">
